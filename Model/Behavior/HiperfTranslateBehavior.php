<?php
namespace Sevenedge\Model\Behavior;
...
/**
 * HiperfTranslate behavior
 */
class HiperfTranslateBehavior extends TranslateBehavior
{
    /**
     * Constructor
     *
    ...
    public function beforeDelete(Event $event, EntityInterface $entity, ArrayObject $options)
    {
        ...
        $translation = $this->_translationTable()->deleteAll($where);
