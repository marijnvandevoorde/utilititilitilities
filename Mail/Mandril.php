...
class Mandril
{
    ...
    public function sendMail($to_emails, $html, $text, $subject, $from_mail = 'no-reply@dewinkelwinkel.be', $from_name = 'De Winkel Winkel', $global_merge_vars = false, $merge_vars = false, $async = false)
    {
